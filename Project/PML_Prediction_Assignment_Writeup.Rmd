...
I also casted all columns from column 8 to the end to be numeric.
...
As can be seen from the confusion matrix of test data above and the error estimation with cross-validation this model is very accurate. I did experiment with PCA 
and other models, but did not get a comparable accuracy. Because my test data (testing) was around 99% 
accurate (out of sample error) I expected nearly all of the submitted test cases to be correct. It turned out they 
were all correct.
